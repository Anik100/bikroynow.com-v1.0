        ...
        <div className={styles.left}>
          <Link href="/" className={styles.logo}>
            ...
            <span className={styles.logoBox}>
              ...
              <span className={styles.logoHut}>HUT</span>
            </span>
            <span className={styles.dotCom}>.com</span>
          </Link>
        </div>

        <div className={styles.right} style={{ display: 'flex', gap: '0.8rem', alignItems: 'center' }}>
          {hasAdminAccess && (
            <Link href="/admin-dashboard" className={styles.postAdBtn} style={{ background: '#d97706', borderColor: '#d97706', color: 'white' }}>
