...
export default function FAQ() {
  ...
  const faqs = [
    {
      q_en: 'How do I post a free ad on BikroyHut?',
      q_bn: 'আমি কীভাবে বিক্রয়হাটে একটি ফ্রি বিজ্ঞাপন দেবো?',
    ...
    {
      q_en: 'Is buying and selling safe on BikroyHut?',
      q_bn: 'বিক্রয়হাটে বেচাকেনা করা কি নিরাপদ?',
      ...
      <div className={styles.card}>
        <div className={styles.pageHeader}>
          ...
          <p className={styles.subtitle}>
            {lang === 'bn' 
              ? 'বিক্রয়হাট সম্পর্কিত সাধারণ প্রশ্ন ও উত্তর' 
              : 'Find quick answers to common questions about using BikroyHut'}
          </p>
        </div>
