      ...
      <div className={styles.card}>
        <div className={styles.pageHeader}>
          ...
          <p className={styles.subtitle}>
            {lang === 'bn' 
              ? 'যেকোনো প্রয়োজনে বিক্রয়নাউ কাস্টমার সাপোর্ট সর্বদা আপনার পাশে রয়েছে' 
              : 'BikroyNow Customer Support is always here to assist you'}
          </p>
        </div>
        ...
        <div className={styles.contentSection}>
          ...
          <div className={styles.contactGrid}>
            ...
            <div className={styles.contactCard}>
              ...
              <p>
                {lang === 'bn'
                  ? 'লেভেল ৪, বিক্রয়নাউ টাওয়ার, গুলশান ২, ঢাকা ১২১২, বাংলাদেশ।'
                  : 'Level 4, BikroyNow Tower, Gulshan 2, Dhaka 1212, Bangladesh.'}
              </p>
            </div>
