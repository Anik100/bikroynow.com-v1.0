      ...
      <div className={styles.card}>
        <div className={styles.pageHeader}>
          ...
          <p className={styles.subtitle}>
            {lang === 'bn' 
              ? 'বিক্রয়নাউতে কীভাবে নিরাপদে কেনাবেচা করবেন' 
              : 'Simple tips to trade safely and securely on BikroyNow'}
          </p>
        </div>
        ...
        <div className={styles.contentSection}>
          <p>
            {lang === 'bn'
              ? 'বিক্রয়নাউতে আমরা আপনার সুরক্ষাকে সর্বোচ্চ অগ্রাধিকার দিই। প্রতারণা ও যেকোনো অপ্রীতিকর পরিস্থিতি এড়াতে অনুগ্রহ করে নিচের গুরুত্বপূর্ণ নিরাপত্তা টিপসগুলো অনুসরণ করুন।'
              : 'At BikroyNow, your safety is our top priority. To prevent scams and avoid unpleasant situations, please always follow these essential safety guidelines.'}
          </p>
