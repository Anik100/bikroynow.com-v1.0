    ...
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        ...
        <div className={styles.contentSection}>
          <p>
            {lang === 'bn'
              ? 'বিক্রয়নাউতে আমরা আপনার ব্যক্তিগত তথ্যের গোপনীয়তা বজায় রাখতে সম্পূর্ণ প্রতিশ্রুতিবদ্ধ। আমরা আপনার তথ্য কীভাবে সংগ্রহ, ব্যবহার এবং সুরক্ষিত রাখি তা এই নীতিমালার মাধ্যমে ব্যাখ্যা করা হলো।'
              : 'At BikroyNow, we are fully committed to maintaining the confidentiality of your personal information. This policy explains how we collect, use, and safeguard your details.'}
          </p>
